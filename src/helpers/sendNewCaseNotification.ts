...
export const sendNewCaseNotification = async (
  adminEmail: string,
  adminName: string,
  channelTitle: string,
  caseId: string,
  ...
  try {
    ...
    const htmlTemplate = `
      ...
      <html>
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1 style="margin: 0; color: #8b5a3c;">🔔 New Case Submitted</h1>
            </div>
            <div class="content">
              <h2>Hello ${adminName}!</h2>
              <p>A new anonymous case has been submitted to your channel.</p>
              ...
              <p>Please review this case in your dashboard to view the encrypted details and take appropriate action.</p>
              
              <p style="margin-top: 20px;">
                <strong>⚠️ Important:</strong> All case content is end-to-end encrypted to protect the whistleblower's identity and ensure confidentiality.
              </p>
    ...
    const mailOptions = {
      from: {
        name: "Whistle Base - New Case Alert",
        address: process.env.GMAIL_USER || "",
      },
      to: adminEmail,
      subject: `New Case Submitted: ${channelTitle} - ${category}`,
      html: htmlTemplate,
      text: `Hello ${adminName}!\n\nA new anonymous case has been submitted to your channel.\n\nChannel: ${channelTitle}\nCategory: ${category}\nCase ID: ${caseId}\nSubmitted: ${new Date().toLocaleString()}\n\nPlease review this case in your dashboard.\n\nBest regards,\nThe Whistle Base Team`,
    };
    ...
    return {
      success: true,
      message: "New case notification sent successfully",
    };
  } catch (error: unknown) {
    console.error("Error sending new case notification:", error);
    ...
    return {
      success: false,
      message: "Failed to send new case notification.",
    };
  }
};
